...
import { DropDownButtonPosition, InputQueryMode, ElementRenderMode} from './../index';
...
export class InputComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges, ControlValueAccessor {
	...
	public declare nativeElement: InputEditor;
  ...
  */
	...
	* @returns {any}
  */
	public async getSelectedItem(value): Promise<any> {
		const getResultOnRender = () => {
            return new Promise(resolve => {
                this.nativeElement.whenRendered(() => {
