...
export class DockingLayout extends React.Component<React.HTMLAttributes<Element> & DockingLayoutProps, any> {   
	...
	* @returns {Node}
  */
	public dock(node:string | number | Node) : any {
        const result: any = this.nativeElement.dock(node);
        return result;
    }
	...
	* @returns {any[]}
  */
	public getAutoHideItems(orientation?:string) : any {
        const result: any = this.nativeElement.getAutoHideItems(orientation);
        return result;
    }
	...
	* @returns {number}
  */
	public getIndex(node:HTMLElement) : any {
        const result: any = this.nativeElement.getIndex(node);
        return result;
    }
	...
	* @returns {any[]}
  */
	public getState(noInstances?:boolean) : any {
        const result: any = this.nativeElement.getState(noInstances);
        return result;
    }
	...
	* @returns {HTMLElement}
  */
	public getItemGroupElement(item?:HTMLElement) : any {
        const result: any = this.nativeElement.getItemGroupElement(item);
        return result;
    }
  ...
  */
	public getJSONStructure() : any {
        const result: any = this.nativeElement.getJSONStructure();
        return result;
    }
