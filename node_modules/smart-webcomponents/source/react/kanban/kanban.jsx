...
export class Kanban extends React.Component {
	...
	*   dataField - The column data field.
	*/
	_onColumnShow = null;	get onColumnShow() {
		return this._onColumnShow;
	}
	set onColumnShow(value) {
		this._onColumnShow = value;
	}
	...
	*   dataField - The column data field.
	*/
	_onColumnHide = null;	get onColumnHide() {
		return this._onColumnHide;
	}
	set onColumnHide(value) {
		this._onColumnHide = value;
	}
	...
	*   dataField - The column data field.
	*/
	_onColumnCollapse = null;	get onColumnCollapse() {
		return this._onColumnCollapse;
	}
	set onColumnCollapse(value) {
		this._onColumnCollapse = value;
	}
	...
	*   dataField - The column data field.
	*/
	_onColumnExpand = null;	get onColumnExpand() {
		return this._onColumnExpand;
	}
	set onColumnExpand(value) {
		this._onColumnExpand = value;
	}
	...
	*   value - The comment object. It has 'text: string, time: Date and userId:number' properties.
	*/
	_onCommentUpdate = null;	get onCommentUpdate() {
		return this._onCommentUpdate;
	}
	set onCommentUpdate(value) {
		this._onCommentUpdate = value;
	}
	...
	*   id - The task data id.
	*/
	_onTaskBeforeAdd = null;	get onTaskBeforeAdd() {
		return this._onTaskBeforeAdd;
	}
	set onTaskBeforeAdd(value) {
		this._onTaskBeforeAdd = value;
	}
	...
	*   id - The task data id.
	*/
	_onTaskUpdate = null;	get onTaskUpdate() {
		return this._onTaskUpdate;
	}
	set onTaskUpdate(value) {
		this._onTaskUpdate = value;
	}
	...
	*   id - The task data id.
	*/
	_onTaskClick = null;	get onTaskClick() {
		return this._onTaskClick;
	}
	set onTaskClick(value) {
		this._onTaskClick = value;
	}
	...
	*   id - The task data id.
	*/
	_onTaskDoubleClick = null;	get onTaskDoubleClick() {
		return this._onTaskDoubleClick;
	}
	set onTaskDoubleClick(value) {
		this._onTaskDoubleClick = value;
	}

	// Gets the events of the React component.
	get eventListeners() {
		return ["onChange","onClose","onClosing","onColumnAdd","onColumnRemove","onColumnReorder","onColumnUpdate","onColumnClick","onColumnDoubleClick","onColumnShow","onColumnHide","onColumnCollapse","onColumnExpand","onCommentAdd","onCommentRemove","onCommentUpdate","onDragEnd","onDragging","onDragStart","onFilter","onOpen","onOpening","onSort","onTaskBeforeAdd","onTaskAdd","onTaskRemove","onTaskUpdate","onTaskClick","onTaskDoubleClick"];
	}
