...
export class Chart extends React.Component<React.HTMLAttributes<Element> & ChartProps, any> {   
  ...
  */
	public getItemCoord(groupIndex:number, serieIndex:number, itemIndex:number) : any {
        const result: any = this.nativeElement.getItemCoord(groupIndex, serieIndex, itemIndex);
        return result;
    }
	...
	* @returns {number}
  */
	public getItemsCount(groupIndex:number, serieIndex:number) : any {
        const result: any = this.nativeElement.getItemsCount(groupIndex, serieIndex);
        return result;
    }
  ...
  */
	public getValueAxisLabels(groupIndex:number) : any {
        const result: any = this.nativeElement.getValueAxisLabels(groupIndex);
        return result;
    }
	...
	* @returns {DOMRect}
  */
	public getValueAxisRect(groupIndex:number) : any {
        const result: any = this.nativeElement.getValueAxisRect(groupIndex);
        return result;
    }
  ...
  */
	public getValueAxisValue(offset:number, groupIndex:number) : any {
        const result: any = this.nativeElement.getValueAxisValue(offset, groupIndex);
        return result;
    }
  ...
  */
	public getXAxisLabels(groupIndex:number) : any {
        const result: any = this.nativeElement.getXAxisLabels(groupIndex);
        return result;
    }
	...
	* @returns {DOMRect}
  */
	public getXAxisRect(groupIndex:number) : any {
        const result: any = this.nativeElement.getXAxisRect(groupIndex);
        return result;
    }
  ...
  */
	public getXAxisValue(offset:number, groupIndex:number) : any {
        const result: any = this.nativeElement.getXAxisValue(offset, groupIndex);
        return result;
    }
