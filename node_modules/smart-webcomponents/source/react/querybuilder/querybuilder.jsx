...
export class QueryBuilder extends React.Component {
	...
	*/
	_onValidationChange = null;	get onValidationChange() {
		return this._onValidationChange;
	}
	set onValidationChange(value) {
		this._onValidationChange = value;
	}

	// Gets the events of the React component.
	get eventListeners() {
		return ["onChange","onDragEnd","onDragging","onDragStart","onItemClick","onPropertySelected","onValidationChange"];
	}
